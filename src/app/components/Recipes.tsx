    ...
    return (
        <section className='w-full min-h-[70vh] bg-headingDark relative'>
            ...
            <div className='pt-28 max-w-[85%] mx-auto'>
                <h3 className='text-3xl text-center text-white font-semibold max-w-md mx-auto md:text-4xl lg:text-5xl xl:text-6xl'>Our users <span className='text-headingGreen'>love </span><br /> these <span className='text-headingGreen'>recipes</span></h3>
                <div className='mt-10 py-10 flex flex-wrap gap-9 justify-center pb-32 '>
